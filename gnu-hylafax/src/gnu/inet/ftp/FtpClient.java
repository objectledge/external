...
// $Id: FtpClient.java,v 1.2 2002/07/13 02:32:15 jaiger Exp $
//
 ...
 * FtpClientProtocol methods for common functionality.
 * <P>
 ...
 **/
public class FtpClient extends FtpClientProtocol 
   ...
   **/
    ...
    * Uses rnfr and rnto internally.
    *
    * @exception IOException an IO error occurred
    * @exception ServerResponseException the server reported an error
    * @exception FileNotFoundException the source file does not exist
