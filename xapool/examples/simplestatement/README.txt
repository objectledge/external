#
#
# Test the Statement implementation with the printTable method
#
#
...
Go to output/dist/examples/simplestatement
...
o Start the example
   ...
   $ java SimpleStatement commit 4

Usage:
------

   $ java SimpleStatement [completion] [value]
