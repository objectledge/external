...
Go to output/dist/examples/multipletransaction
...
o Set the classpath
   ...
   $ export CLASSPATH=../../lib/log4j.jar:../../lib/jta-spec1_0_1.jar:../../lib/jotm.jar:../../lib/jotm_jrmp_stubs.jar:../../config:.:../../lib/xapool.jar:.:../../lib/commons-logging-api.jar:../../lib/commons-logging.jar:../../lib/p6spy.jar:../../lib/connector-1_5.jar:../../lib/howl.jar:$JDBC_JARS
...
o Start the example
   ...
   $ java MultipleTransaction 4

Usage:
------

   $ java MultipleTransaction [value]
