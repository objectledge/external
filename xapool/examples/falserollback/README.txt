#
#
# Verify that setAutoCommit(false) on a connection rollback
# the connection when connection is closed
#
#
...
Go to output/dist/examples/falserollback
...
o Start the example
   ...
   $ java FalseRollback 4

Usage:
------

   $ java FalseRollback [value]
